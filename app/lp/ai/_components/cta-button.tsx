...
const CAL_URL = "https://timerex.net/s/kosaku.tsubata_9a21/1662a2ee"
...
export function CTAButton({
  ...
  if (variant === "sub") {
    return (
      <div>
        <a
          href="mailto:info@miitaso.com?subject=AI導入支援サービス資料のご請求&body=AI導入支援サービスの資料を希望します。%0A%0A会社名：%0Aお名前：%0Aご連絡先："
          onClick={() => trackEvent("document_request")}
