...
const pageDescription =
  "要件定義から運用まで、一気通貫。AI駆動開発により、Webアプリ・業務システム・モバイルアプリを速く・確かに開発します。他社見積2,000万円の開発を500万円で実現した実例があります。"
...
const strengths = [
  {
    title: "AI駆動開発による開発効率",
    description:
      "Claude などの AI を開発プロセスに常用し、設計・実装・テストを高速に回しています。AIエージェントが市場調査レポートを自動生成する自社プロダクトも、同じ手法で開発・運用しています。",
  },
  {
    title: "実例のあるコスト効率",
    description:
      "他社から2,000万円の見積もりが出ていたペットオーナー向けSNSアプリ（Flutter）を、500万円で実現した実例があります。AI駆動開発と無駄のない体制で、品質を保ちながらコストを抑えます。",
  },
  {
    title: "代表自身がエンジニア",
    description:
...
const cases = [
  {
    ...
    description:
      "他社では2,000万円の見積もりだったSNSアプリを、Flutter と AI駆動開発により500万円で開発しました。",
    ...
    <div className="bg-[#030712]">
      ...
      <main>
        <ServiceHero
          ...
          lead="AI駆動開発で、速く・確かに作ります。代表自身がエンジニアとして要件定義から設計・開発・運用までを担い、Claude などの AI を開発プロセスに常用することで、品質とスピードを両立しています。"
          bullets={[
            "Claude などの AI を開発プロセスに常用し、開発効率を高めています",
