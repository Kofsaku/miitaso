...
const pageDescription =
  "要件定義から運用まで、一気通貫。Webアプリ・業務システム・モバイルアプリを、成果から逆算して速く・確かに開発します。他社見積の25%のコストで実現した実例があります。"
...
const strengths = [
  {
    title: "AIを使い切る開発プロセス",
    description:
      "Claude などの AI を開発プロセスに常用し、設計・実装・テストのサイクルを高速に回しています。AIがWeb検索で市場調査レポートを生成する自社ツールも、同じ手法で開発し、サイトで公開しています。",
  },
  {
    title: "実例のあるコスト効率",
    description:
      "他社見積の25%のコストでペットオーナー向けSNSアプリ（Flutter）を実現した実例があります。本当に必要な機能の見極めと無駄のない体制で、品質を保ちながらコストを抑えます。",
  },
  {
    title: "代表自身がエンジニア",
    description:
...
const cases = [
  {
    ...
    description:
      "他社見積の25%のコストで、Flutter の採用とスコープの見極めによりSNSアプリを開発しました。",
  ...
  },
  {
    ...
    title: "picture-book",
    description:
      "文章に合わせた絵柄やレイアウトをAIで生成し、一人ひとりに合わせたオリジナル絵本をつくれる自社プロダクトです。",
  },
]
