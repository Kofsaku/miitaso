...
const cases = [
  {
    ...
    title: "research",
    description:
      "LINEで事業アイデアを送ると、AIエージェントが市場調査して数分でレポートを自動生成・公開するbot。企画から開発、運用まで自社で行っています。",
  },
  {
    category: "自社プロダクト",
    title: "Japan Property",
    description:
      "海外投資家向けに日本の温泉地物件を紹介する英語サイト。多言語LPと問い合わせ導線を自社で企画・開発し、運用しています。",
  },
  {
    category: "自社プロダクト",
    title: "マイクラ English",
    description:
      "「遊んでたら、英語ができてた。」マインクラフトと英語学習を掛け合わせたサービスを自社で立ち上げています。",
  },
  {
    category: "コンサルティング",
    title: "自治体の電子通貨アプリ",
    ...
    <div className="bg-[#030712] antialiased">
      ...
      <main>
        <ServiceHero
          ...
          lead="アイデアを検証する最短の方法は、動くものを市場に出してみることです。miitasoはエンジニアが企画段階から伴走するため、調査・設計・開発・改善のサイクルが分断で止まりません。"
          bullets={[
