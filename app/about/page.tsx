          ...
          <div className="grid items-start gap-12 lg:grid-cols-[auto_1fr]">
            ...
            <Reveal delay={120}>
              ...
              <div className="mt-6 space-y-5 leading-relaxed text-slate-300">
                <p>
                  自動車部品商社で海外調達と開発営業を経験したのち、運送・物流SaaSのスタートアップへ。「売る側」から「つくる側」へ——営業職からエンジニアに転身しました。Ruby・JavaScript・AWSを用いたSalesforce
                  API連携やスクレイピング基盤を、要件定義から実装・運用まで一人で構築。このデータ連携基盤が、車両掲載台数を業界8位から2位へと押し上げる原動力になりました。
                </p>
                <p>
                  2021年からはフリーランスとして、開発・PM案件を数多く担当。ベトナム・バングラデシュなど多国籍のオフショアチームのマネジメントから、他社見積2,000万円規模のアプリを500万円で実現する開発まで、上流の設計から実装・運用までを一貫して引き受けてきました。
                </p>
                <p>
                  2024年12月、miitasoを創業。メインスタックはNext.js / React /
                  TypeScriptで、ClaudeやOpenAIを使ったAI機能の実装実績も多数。自分たちで事業とプロダクトをつくり、運用し続けているからこそ、机上の空論ではない、実装まで見据えた提案ができます。
                </p>
              </div>
            </Reveal>
          </div>
